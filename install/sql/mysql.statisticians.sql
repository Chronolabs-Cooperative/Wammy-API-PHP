...
CREATE TABLE `statisticians` (
  `rid` mediumint(196) NOT NULL,
  `jid` mediumint(196) NOT NULL,
  `sid` mediumint(128) NOT NULL,
  `wid` mediumint(64) NOT NULL,
  ...
  `beath` enum('Yes','No') NOT NULL,
  `index` mediumint(32) NOT NULL,
  `total` mediumint(32) NOT NULL,
