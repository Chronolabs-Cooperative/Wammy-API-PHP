...
--
-- Table structure for table `statisticians`
--

DROP TABLE IF EXISTS `statisticians`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `statisticians` (
  ...
  `chars` int(12) NOT NULL DEFAULT '0',
  `numbers` int(12) NOT NULL DEFAULT '0',
  `words` int(12) NOT NULL DEFAULT '0',
  `spammers` int(12) NOT NULL DEFAULT '0',
  `hammers` int(12) NOT NULL DEFAULT '0',
  `crassifications` int(12) NOT NULL DEFAULT '0',
  `breaths` int(12) NOT NULL DEFAULT '0',
  ...
  `beath` enum('Yes','No') NOT NULL  DEFAULT 'No',
  ...
  PRIMARY KEY (`rid`,`jid`,`sid`,`wid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `statisticians`
--

LOCK TABLES `statisticians` WRITE;
/*!40000 ALTER TABLE `statisticians` DISABLE KEYS */;
/*!40000 ALTER TABLE `statisticians` ENABLE KEYS */;
UNLOCK TABLES;
