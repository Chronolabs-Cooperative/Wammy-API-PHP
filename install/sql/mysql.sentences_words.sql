...
DROP TABLE IF EXISTS `sentences_words`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sentences_words` (
  `swid` mediumint(255) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`swid`,`jid`,`wid`,`sid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sentences_words`
--

LOCK TABLES `sentences_words` WRITE;
/*!40000 ALTER TABLE `sentences_words` DISABLE KEYS */;
/*!40000 ALTER TABLE `sentences_words` ENABLE KEYS */;
UNLOCK TABLES;
