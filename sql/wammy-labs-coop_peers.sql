...
CREATE TABLE `peers` (
  ...
  `api-uri-spam` varchar(200) NOT NULL,
  `api-uri-ham` varchar(200) NOT NULL,
  `api-uri-forget` varchar(200) NOT NULL,
  ...
  PRIMARY KEY (`peerid`,`api-uri`,`api-uri-spam`,`api-uri-ham`,`api-uri-forget`,`polinating`)
