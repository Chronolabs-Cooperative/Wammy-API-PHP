 ...
 * @package             kernel
 * @since               2.0.0
 * @author              Kazumi Ono (http://www.myweb.ne.jp/, http://jp.api.org/)
 ...
 * $maxfilewidth = 120;
 * $maxfileheight = 120;
 * $uploader = new APIMediaUploader('/home/api/uploads', $allowed_mimetypes, $maxfilesize, $maxfilewidth, $maxfileheight);
...
class APIMediaUploader
{
    ...
    {
        $this->extensionToMime = include $GLOBALS['api']->path('include/mimetypes.inc.php');
        ...
        if (!include_once $GLOBALS['api']->path('language/' . $GLOBALS['apiConfig']['language'] . '/uploader.php')) {
            include_once $GLOBALS['api']->path('language/english/uploader.php');
        }
    }
